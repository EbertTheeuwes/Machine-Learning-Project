...
class DQN(rl_agent.AbstractAgent):
    ...
    def __init__(self,
                 player_id,
                 state_representation_size,  # this should now be length of dbn string
                 num_actions,
    ...
    def step_mod(self, time_step, state, is_evaluation=False, add_transition_record=True):
        ...
        if not is_evaluation:
            ...
            if self._prev_timestep and add_transition_record:
                ...
                self.add_transition(self._prev_timestep, self._prev_action, self._prev_state, time_step, state)
    ...
    def add_transition(self, prev_time_step, prev_action, prev_state, time_step, state):
    ...
    def _epsilon_greedy(self, info_state, legal_actions, epsilon):
        ...
        if np.random.rand() < epsilon:
            ...
            q_values = self._q_network(info_state).detach()
    ...
    def learn(self):
        ...
        max_next_q = torch.max(legal_target_q_values, dim=1)[0] # dit mss nog checken of dimensies kloppen
